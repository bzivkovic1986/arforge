...
def readme_md(system_name: str, *, no_example: bool = False) -> str:
    example_note = (
        ...
        "- `modes/power_state.yaml` defines a placeholder mode declaration group.\n"
    ...
    if no_example:
        example_note = (
            ...
            "- Update the placeholder mode declaration groups under `modes/`.\n"
...
def mode_declaration_groups_yaml() -> str:
    return _with_header(
        ...
        "Defines placeholder AUTOSAR mode declaration groups that can be expanded later.",
body="""modeDeclarationGroups:
  - name: "Mdg_PowerState"
    description: "Placeholder power-state mode declaration group generated by the scaffold."
    initialMode: "OFF"
    modes:
      - "OFF"
      - "ON"
